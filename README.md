...
5. **Turn on GitHub Pages.**
   ...
   browser to confirm you see your styled meal table (Dinner/Lunch/School
   Lunch columns, one row per day, a faint green tint so it still reads as
   its own block against whatever's behind it on your dashboard).
